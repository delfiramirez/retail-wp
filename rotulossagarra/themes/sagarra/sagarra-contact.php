            ...
            <div id="rotulos">
                ...
                <div id="contact-sagarra" class="contact-sagarra-rotulos">
                    ...
                    <h2 itemscope itemtype="http://schema.org/Organization">
                        <span itemprop="name">
                            <?php _e ("<!--:en-->Rotulos Sagarra, Inc.<!--:--><!--:es-->R&oacute;tulos Sagarra, SA.<!--:--><!--:ca-->R&egrave;tols Sagarra, SA.<!--:-->"); ?>
                        </span>
                    </h2>

                    <h3>
                        <?php _e ("<!--:en-->We are attending you at<!--:--><!--:es--> Estamos a su disposición en<!--:--><!--:ca-->Estem a ala seua disposició a<!--:-->"); ?>
                    </h3>
